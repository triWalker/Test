...
public class SemanticError extends CompilerError
{
	...
	public static SemanticError ExpectedConjunction(String found, int line)
	{
		return new SemanticError(Type.BAD_RELOP,
				">>> ERROR on line " + line + " : Expected an AND/OR, but found " + found);
	}

	public static SemanticError InvalidParameter(SymbolTableEntry expected, SymbolTableEntry found, int line)
	{
		return new SemanticError(Type.BAD_PARM_TYPE,
